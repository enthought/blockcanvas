...
# Geo Library imports
from geo.context.api import NumericContext, TraitsContext
from abstract_context_test_case import AbstractContextTestCase

class TraitsContextTestCase(AbstractContextTestCase):
    ...
    def context_factory(self, *args, **kw):
        ...
        """
        return TraitsContext( NumericContext(*args, **kw) )
    ...
    ############################################################################
    # TraitsContextTestCase interface
    ############################################################################
    ...
    def HIDE_test_eval_is_not_slow(self):
        ...
        this_setup = "from geo.context.api import NumericContext, TraitsContext\n" \
                     "context=TraitsContext(NumericContext())\n" \
                     "context['vp'] = vp\n"
