...
from data_context import ListenableMixin, PersistableMixin
from i_context import ICheckpointable, IListenableContext, IPersistableContext
...
class ExpressionContext(ListenableMixin, PersistableMixin, DictMixin):
    ...
    def __getitem__(self, key):
        if key in self.underlying_context.keys():
            ...
            #eval expression if not cached and return
            pass
