...
# Geo Library imports
from geo.context.api import NumericContext, ReductionContext
from abstract_context_test_case import AbstractContextTestCase

class ReductionContextTestCase(AbstractContextTestCase):
    ...
    def context_factory(self, *args, **kw):
        ...
        """
        return ReductionContext( NumericContext(*args, **kw) )
    ...
    ############################################################################
    # ReductionContextTestCase interface
    ############################################################################
    ...
    def HIDE_test_eval_is_not_slow(self):
        ...
        this_setup = "from geo.context.api import NumericContext, ReductionContext\n" \
                     "context=ReductionContext(NumericContext())\n" \
                     "context['vp'] = vp\n"
